...
Console.WriteLine(string.Join(Environment.NewLine, result, 0, realSize)); // вывод в консоль сторок прошедших проверку
Console.ReadKey(true); // ожидание ввода пользователем любого символа с клавиатуры для завершения работы програмы